...
export const gameCMD = {
    ...
    SUB_GF_CANCEL_USER_READY: 9, // 取消用户准备
...
export const corresCMD = {
    ...
    WRITE_DIAMOND: "WriteDiamond", //玩家写分
    COST_DIAMOND: "CostDimaind", //口房卡
    OPEN_OK: "OpenOK", //房间开启成功
    onUserOffline: "onUserOffline", //用户掉线    
    onUserRelogin: "onUserRelogin", //用户掉线    
    ENTER_ROOM: "EnterRoom", //用户掉线    
    WRITE_SCORE_NEW: "WriteScoreNew", //写数据 
    TABLE_START: "TableStart", //桌子开始数据       
    SAVE_CLUB_SCORE: "SaveClubScore", //游戏结束 写入俱乐部积分

    BROAD_CAST: "BroadCast", //全服广播
